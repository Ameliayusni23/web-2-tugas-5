...
?>
<?php
$p1 = new accountBank("", "Ica", "");
$p1->daftar();
$p1->nabung(1000000);

$p2 = new accountBank("", "Hani","" );
$p2->daftar();
$p2->tarik(2500000);
?>

<?php
    $p1 = ['id'=> 1, 'nomor' => 'C001', 'nama' => 'Ica', 'saldo' => 6000000];
    $p2 = ['id'=> 2, 'nomor' => 'C002', 'nama' => 'Hani', 'saldo' => 5350000];
    $p3 = ['id'=> 3, 'nomor' => 'C003', 'nama' => 'Nur', 'saldo' => 2500000];
